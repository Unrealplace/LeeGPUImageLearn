...
- (void)setBlurEnabled:(BOOL)blurEnabled
{
    ...
    if (blurEnabled)
    {
        for (ACBlurView *view in self.views)
        {
...
- (void)removeView:(ACBlurView *)view
{
...
- (id<CAAction>)actionForLayer:(CALayer *)layer forKey:(NSString *)key
{
    ...
    NSLog(@"---->>>>%@",[super actionForLayer:layer forKey:key]);
